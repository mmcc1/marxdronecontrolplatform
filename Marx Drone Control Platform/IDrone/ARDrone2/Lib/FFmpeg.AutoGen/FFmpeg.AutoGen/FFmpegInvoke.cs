...
namespace FFmpeg.AutoGen
{
	...
	{
		public const string AVCODEC_LIBRARY = "avcodec-54.dll";
		public const string AVFILTER_LIBRARY = "avfilter-3.dll";
		public const string SWRESAMPLE_LIBRARY = "swresample-0.dll";
		public const string AVUTIL_LIBRARY = "avutil-52.dll";
		public const string AVFORMAT_LIBRARY = "avformat-54.dll";
		public const string SWSCALE_LIBRARY = "swscale-2.dll";
		public const string POSTPROC_LIBRARY = "postproc-52.dll";
		public const string AVDEVICE_LIBRARY = "avdevice-54.dll";
